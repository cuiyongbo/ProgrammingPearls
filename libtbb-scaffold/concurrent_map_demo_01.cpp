...
void std_set_test(int mapSize)
{
    ...
    cout << "std::set test using " << TIMER_MSEC(std_set_test) << " milliseconds" << endl;
}
...
void tbb_concurrent_set_test(int mapSize)
{
    ...
    cout << "tbb::concurrent_set test using " << TIMER_MSEC(tbb_concurrent_set_test) << " milliseconds" << endl;
}